...
const Poster = ({ poster_path, title, name, vote_average, cover }: Movie, index: number ) => {
  const { IMAGEURL } = CONST;
  return (
    <article className="relative transition-all duration-300 ease-in-out transform hover:scale-110 hover:z-10" key={index}>
